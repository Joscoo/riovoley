...
const DeleteEntrenadorConfirmModal = ({ open, onCancel, onConfirm }) => {
  if (!open) return null;
  ...
  return (
    <div className="fixed inset-0 z-[95] flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm" onClick={onCancel}>
      ...
      >
        <h3 className="text-lg font-bold text-red-200">Eliminar entrenador</h3>
        <p className="mt-3 text-sm text-slate-200">Estas seguro de eliminar este entrenador?</p>
...
DeleteEntrenadorConfirmModal.propTypes = {
  open: PropTypes.bool.isRequired,
  onCancel: PropTypes.func.isRequired,
  onConfirm: PropTypes.func.isRequired,
};

export default DeleteEntrenadorConfirmModal;
