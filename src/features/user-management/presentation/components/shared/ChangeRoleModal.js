...
import { FaExchangeAlt, FaTimes, FaExclamationTriangle } from 'react-icons/fa';
import { Card, Button, iconRegistry, getRoleLabel } from '../../../../../shared/ui';
...
const ChangeRoleModal = ({ user, currentRole, onConfirm, onCancel, isSubmitting = false }) => {
  ...
  const availableRoles = [
    { value: 'estudiante', label: 'Estudiante', icon: <StudentIcon /> },
    { value: 'entrenador', label: 'Entrenador', icon: <TrainerIcon /> },
    { value: 'administrador', label: 'Administrador', icon: <AdminIcon /> },
